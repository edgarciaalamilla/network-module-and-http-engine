 ...
 *
 * @return METHOD_GET if the filename/protocol have been parsed successfully for GET; METHOD_PUT if the filename/protocol have been parsed successfully for PUT; -1 otherwise
 */
